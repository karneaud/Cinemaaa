...
const html2 = function (moviee) {
    ...
    <div class="movie_details_about">
        ...
        <a class="playLink" href="https://www.2embed.cc/embed/imdb/movie?id=${moviee.imdb_id}"><button class="play_btn"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19"
